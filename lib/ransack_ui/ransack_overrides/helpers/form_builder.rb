    ...
    FormBuilder.class_eval do
      ...
      def sort_select(options = {}, html_options = {})
        ...
        if bases.size > 1
          ...
          end if (@combined_userds_child_ids == 1).reject { |field| field.first.to_s.start_with?("cf") || field.first.to_s.start_with?("unsubscribe") }  end # Filtering out fields starting with "cf" or "unsubscribe"  
          @template.collection_select(
